    ...
    levels: [
        {
            ...
            items: {
                '4,4': { 
                    text: "追光者：一潭深色的湖泊，散发着甜腻而危险的气息。凡人们称之为“甜蜜的诱惑”。",
                    image: '1cola.png'
                }
            }
        },
        {
            ...
            items: {
                '5,3': {
                    text: "追光者：我感觉到空气在发烫，那是圣光的余温。我正在接近它的外环。",
                    image: '2dim.png'
                }
            }
        },
        {
            ...
            items: {
                '2,4': {
                    text: "追光者： 这不是天使的羽毛……而是一片被烧焦的翅膀残骸。看来曾有‘先行者’在此陨落。",
                    image: '3wings.png'
                },
                '5,6': {
                    text: "追光者： 巨大的轰鸣声在耳边炸响……这是神之国的唱诗班在为我加冕。",
                    image: '4flash.png'
                }
            }
        }
